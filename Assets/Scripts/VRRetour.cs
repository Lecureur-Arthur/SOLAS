...
public class VRRetour : MonoBehaviour
{
    ...
    public RetourVaisseau retourVaisseauScript;  // Référence au script RetourVaisseau
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (!isPressed)
        {
            ...
            if (retourVaisseauScript != null)
            {
                retourVaisseauScript.StartLoadingMoonScene();  // Change la scène
            }
        }
    }
