...
public class VRAtterrissageTerre : MonoBehaviour
{
    ...
    public AtterrissageTerre atterrissageTerre;  // Référence au script RetourVaisseau
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (!isPressed)
        {
            ...
            if (atterrissageTerre != null)
            {
                atterrissageTerre.StartLoadingTerreScene();  // Change la scène
            }
        }
    }
