...
public class VRAtterrissageMars : MonoBehaviour
{
    ...
    public AtterrissageMars atterrissageMars;  // Référence au script RetourVaisseau
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (!isPressed)
        {
            ...
            if (atterrissageMars != null)
            {
                atterrissageMars.StartLoadingMarsScene();  // Change la scène
            }
        }
    }
